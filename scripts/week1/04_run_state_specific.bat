@echo off
REM Week 1: STATE_SPECIFIC Strategy Experiments
...
echo ======================================================================
echo Week 1: STATE_SPECIFIC Initialization Strategy
echo ======================================================================
echo Start time: %date% %time%
echo Strategy: %STRATEGY%
echo Window: This window is dedicated to STATE_SPECIFIC experiments
echo ======================================================================
echo.
...
echo ======================================================================
echo STATE_SPECIFIC Strategy Complete
echo ======================================================================
