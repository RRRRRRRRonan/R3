"""Regression test for contextual charging RL on the medium scenario."""
...
def test_charging_rl_medium_executes_and_limits_charge() -> None:
    result = run_contextual_charging_trial("medium")
