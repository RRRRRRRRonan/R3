"""Regression test for contextual charging RL on the small scenario."""
...
def test_charging_rl_small_executes_and_limits_charge() -> None:
    result = run_contextual_charging_trial("small")
